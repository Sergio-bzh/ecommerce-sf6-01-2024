 ...
 */
final class Version20240104154934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cathegories (id INT AUTO_INCREMENT NOT NULL, cathegories_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, INDEX IDX_B27E9CACDC6AF8AB (cathegories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE coupons (id INT AUTO_INCREMENT NOT NULL, coupons_types_id INT NOT NULL, code VARCHAR(10) NOT NULL, description LONGTEXT NOT NULL, max_usage INT NOT NULL, validity DATETIME NOT NULL, is_valid TINYINT(1) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_F56411183DDD47B7 (coupons_types_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE orders_coupons (orders_id INT NOT NULL, coupons_id INT NOT NULL, INDEX IDX_4116363CFFE9AD6 (orders_id), INDEX IDX_41163636D72B15C (coupons_id), PRIMARY KEY(orders_id, coupons_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cathegories ADD CONSTRAINT FK_B27E9CACDC6AF8AB FOREIGN KEY (cathegories_id) REFERENCES cathegories (id)');
        ...
        $this->addSql('ALTER TABLE orders_coupons ADD CONSTRAINT FK_4116363CFFE9AD6 FOREIGN KEY (orders_id) REFERENCES orders (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE orders_coupons ADD CONSTRAINT FK_41163636D72B15C FOREIGN KEY (coupons_id) REFERENCES coupons (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5AA21214B7 FOREIGN KEY (categories_id) REFERENCES cathegories (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE cathegories DROP FOREIGN KEY FK_B27E9CACDC6AF8AB');
        ...
        $this->addSql('ALTER TABLE orders_coupons DROP FOREIGN KEY FK_4116363CFFE9AD6');
        $this->addSql('ALTER TABLE orders_coupons DROP FOREIGN KEY FK_41163636D72B15C');
        ...
        $this->addSql('DROP TABLE orders_coupons');
