 ...
 */
final class Version20240106112935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cathegories ADD slug VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE coupons_types ADD created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupons_types DROP created_at');
        $this->addSql('ALTER TABLE cathegories DROP slug');
